  ...
  return (
    <div className={`group relative w-36 shrink-0 snap-start md:w-44 ${className}`}>
      ...
      <div className="manga-card-hover-layer pointer-events-none absolute inset-0 z-40">
        <div className="manga-card-hover-panel absolute inset-0 hidden flex-col justify-end overflow-hidden rounded-lg bg-gradient-to-t from-zinc-950 via-zinc-950/80 to-transparent p-3 pt-16 md:flex">
