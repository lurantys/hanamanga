    ...
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-zinc-950 px-6">
      ...
      <div className="relative flex flex-col items-center text-center">
        ...
        <Image
          ...
          height={250}
          priority
          className="mt-10 h-56 w-auto rounded-2xl object-cover drop-shadow-[0_0_40px_rgba(239,68,68,0.15)]"
        />
      ...
      <div className="absolute bottom-8 left-1/2 flex -translate-x-1/2 items-center gap-4 text-sm">
        <Link
          href="/browse"
