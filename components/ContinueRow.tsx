          ...
          <MangaCard
            ...
            actions={
              <button
                ...
                className={`absolute left-1.5 top-1.5 z-20 inline-flex h-7 w-7 items-center justify-center rounded-full bg-zinc-950/80 text-zinc-300 shadow-lg transition-colors duration-200 hover:bg-red-500 hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-white/80 md:opacity-0 md:group-hover:opacity-100 md:group-focus-within:opacity-100 pointer-coarse:opacity-100 ${focusRing}`}
              >
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
