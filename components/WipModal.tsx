  ...
  return (
    ...
    >
      <div
        ...
        className="relative w-full max-w-md overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900 shadow-2xl shadow-zinc-950/60"
      >
        ...
        <div className="flex flex-col items-center gap-5 px-6 py-10 text-center">
          ...
          <div className="space-y-2">
            <h3 className="text-2xl font-bold text-white">Manga Reader Under Construction</h3>
            {title && (
          ...
          <div className="flex flex-wrap justify-center gap-3 pt-2">
            <button
              type="button"
              onClick={onClose}
              className="rounded-lg bg-emerald-500 px-6 py-2.5 text-sm font-bold text-zinc-950 transition-colors hover:bg-emerald-400"
            >
              Back to Catalog
            </button>
            <button
              type="button"
              onClick={onClose}
              className="rounded-lg border border-zinc-700 px-6 py-2.5 text-sm font-semibold text-zinc-200 transition-colors hover:bg-zinc-800"
            >
              Close
            </button>
          </div>
