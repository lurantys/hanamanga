...
const PROVIDERS: {
...
}[] = [
  {
    ...
    tileClass: "bg-gradient-to-br from-sky-400 to-blue-600",
  },
  {
    provider: "mal",
    name: "MyAnimeList",
    ...
    tileClass: "bg-gradient-to-br from-indigo-500 to-blue-800",
  },
];
...
function ProviderLogo({
  ...
  return provider === "anilist" ? (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
      <path
        d="M17 3v18h-4l-6-18h4l3.5 10.5L18 3h-1Z"
        stroke="currentColor"
        strokeWidth="1.5"
    ...
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
      <path
        d="M12 6C9 6 6.5 8.5 6 11h2c.5-1.5 1.5-2.5 4-2.5s3.5 1 4 2.5h2c-.5-2.5-3-5-6-5Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
